...
def index_detail(request):
    return render(request, 'demo_app/event.html')

def event_detail(request, case_number):
    if request.method == 'GET':
        return render(request, 'demo_app/event.html')
    elif request.method == 'POST':
        # return render(request, 'demo_app/ok.html')
...
def confirm_detail(request):
    if request.method == 'GET':
        return render(request, 'demo_app/confirm.html')
    elif request.method == 'POST':
...
def case_detail(request):
    if request.method == 'GET':
        return render(request, 'demo_app/case.html')
    elif request.method == 'POST':
